        ...
        <tbody>
            @foreach($regprogdanual as $detpa)
                ...
                <tr>
                    ...
                    <td style="color:purple;text-align:left; vertical-align: middle;font-size:9px;">% </td>
                    <td style="color:purple;text-align:left; vertical-align: middle;font-size:9px;">  </td>
                    <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;">{{number_format($detpa->tot_p01,2)}}</td>
        ...
        <table class="table table-sm" align="center">
            ...
            <tr>
                <td style="border:0;text-align:center;font-size:10px;">
                    Elaboró <br><br>________________________________<br>
                    <b>{{$encpa->responsable}}</b><br>
                    <b>{{$encpa->respo_cargo}}</b>
                </td>
                <td style="border:0;text-align:center;font-size:10px;">
                    Revisó  <br><br>_________________________________<br>
                    <b>{{$encpa->elaboro}}</b><br>
                    <b>{{$encpa->elab_cargo}}</b>
                </td>
                <td style="border:0;text-align:center;font-size:10px;">
                    Autorizó<br><br>_________________________________<br>
