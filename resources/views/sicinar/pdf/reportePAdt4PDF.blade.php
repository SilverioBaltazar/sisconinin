...
@section('content')
    ...
    <section id="content">
        ...
        <tr>
            ...
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Octubre   </b></th>
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Noviembre </b></th>
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Diciembre </b></th>
        ...
        <tbody>
            @foreach($regprogdanual as $detpa)
                <tr>
                    ...
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_10,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_10,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p10,2)}}</td> 

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_11,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_11,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p11,2)}}</td>

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_12,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_12,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p12,2)}}</td>

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trimp_04,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trimc_04,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trim_p04,2)}}</td>
                    <td style="text-align:center;vertical-align: middle;font-size:09px;">  
                    @switch($detpa->semaft_04)
                        @case('1')
