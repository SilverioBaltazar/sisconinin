...
@section('content')
    ...
    <section id="content">
        ...
        <tr>
            ...
            <th colspan="3" style="text-align:center;vertical-align:middle;font-size:11px;">Enero   </th>
            <th colspan="3" style="text-align:center;vertical-align:middle;font-size:11px;">Febrero </th>
            <th colspan="3" style="text-align:center;vertical-align:middle;font-size:11px;">Marzo   </th>
            <th colspan="4" style="text-align:center;vertical-align: middle;font-size:11px;">Trimestre 1 </th>
            <th colspan="4" style="text-align:center;vertical-align: middle;font-size:11px;">Acum. al periodo</th>
        </tr>                                
        <tr>
            ...
            <th style="background-color:darkgreen;text-align:left;"><b style="color:white;font-size: x-small;">Meta<br>Anual </b>
            </th>                         
