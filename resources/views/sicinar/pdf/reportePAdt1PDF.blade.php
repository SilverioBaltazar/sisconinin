...
@section('content')
    ...
    <section id="content">
        ...
        <tr>
            ...
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Enero</b></th>
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Febrero</b></th>
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Marzo  </b></th>
            <th colspan="4" style="background-color:darkorange;text-align:center;"><b style="color:white;font-size:10px;">Trimestre 1</b></th>
        ...
        <tbody>
            @foreach($regprogdanual as $detpa)
                <tr>
                    ...
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_01,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_01,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p01,2)}}</td> 

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_02,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_02,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p02,2)}}</td>

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_03,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_03,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p03,2)}}</td>

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trimp_01,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trimc_01,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trim_p01,2)}}</td>
                    <td style="text-align:center;vertical-align: middle;font-size:09px;">  
                    @switch($detpa->semaft_01)
                        @case('1')
