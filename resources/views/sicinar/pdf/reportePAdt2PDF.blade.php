...
@section('content')
    ...
    <section id="content">
        ...
        <tr>
            ...
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Abril      </b></th>
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Mayo       </b></th>
            <th colspan="3" style="background-color:darkgreen; text-align:center;"><b style="color:white;font-size:10px;">Junio      </b></th>
        ...
        <tbody>
            @foreach($regprogdanual as $detpa)
                <tr>
                    ...
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_04,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_04,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p04,2)}}</td> 

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_05,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_05,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p05,2)}}</td>

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesp_06,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mesc_06,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->mes_p06,2)}}</td>

                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trimp_02,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trimc_02,0)}}</td>
                    <td style="text-align:right; vertical-align: middle;font-size:09px;">{{number_format($detpa->trim_p02,2)}}</td>
                    <td style="text-align:center;vertical-align: middle;font-size:09px;">  
                    @switch($detpa->semaft_02)
                        @case('1')
