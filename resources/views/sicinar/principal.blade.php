...
<head> 
      ...
      <title>@yield('title','Inicio') | SISCONIN </title>
      ...
      <div class="wrapper">
        ...
        <header class="main-header">
          ...
          <a href="#" class="logo">
            ...
            <span class="logo-lg"><b> SISCONIN  </b></span>
          </a>
        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li  class="treeview">
                <a href="#"><i class="fa fa-cubes"></i> <span>Diagnóstico </span>
                  <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>              
                <ul class="treeview-menu">
                  @if(session()->get('rango') == '0')
                        <li><a href=""  ><i class="fa fa-file-o"></i>Directorio de Instituciones Federales    </a></li>
                        <li><a href="{{route('verdirdiploc')}}"><i class="fa fa-file-o"></i>Directorio de Diputados loc.</a></li>
                        <li><a href="{{route('verdirdhs')}}"   ><i class="fa fa-file-o"></i>Directorio de Des.Hum.y Soc.</a></li>
                        <li><a href=""><i class="fa fa-wheelchair-alt"></i>Mapas geograficos      </li>
                  @else
                      @if(session()->get('rango') == '1')
                          <li><a href=""  ><i class="fa fa-file-o"></i>Directorio de Instituciones Federales    </a></li>
                          <li><a href="{{route('verdirdiploc')}}"><i class="fa fa-file-o"></i>Directorio de Diputados loc.</a></li>
              ...
              <li  class="treeview">
                ...
                <ul class="treeview-menu"> 
                  <li><a href="{{route('reportemensualfiltro_v2')}}"><i class="fa fa-circle-o"></i>Mensual v.2     </a></li>                                    
                  <li><a href="{{route('reportepafiltro')}}"     ><i class="fa fa-circle-o"></i>Trimestral finanzas </a></li>
                </ul>
                @endif
              </li>
              ...
              <li  class="treeview">
                ...
                <ul class="treeview-menu"> 
                  <li><a href="{{route('graficaxdepen')}}"  ><i class="fa fa-circle-o"></i>Por dependencia </a></li> 
                  <li><a href="{{route('graficaxtipproy')}}"><i class="fa fa-circle-o"></i>Por tipo de proyecto</a></li>                   
                </ul>
                @endif
              </li>
