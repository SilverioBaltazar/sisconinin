            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        {!! Form::open(['route' => 'verreportemensual_v2', 'method' => 'POST','id' => 'verreportemensual_v2', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
...
@section('request')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\reportemensualfiltro2Request','#verreportemensual_v2') !!}
@endsection
