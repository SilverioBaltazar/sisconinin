                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-2 form-group">
                                    <input type="hidden" id="mes_id" name="mes_id" value="{{$mes}}">  
                                        @switch($mes)
                                        @case('1')
                                            <label >Avance del mes de <b style="color:green;">enero </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_01}}" required>
                                            @break
                                        @case('2')
                                            <label >Avance del mes de <b style="color:green;">febrero </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_02}}" required>
                                            @break
                                        @case('3')
                                            <label >Avance del mes de <b style="color:green;">marzo </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_03}}" required>
                                            @break
                                        @case('4')
                                            <label >Avance del mes de <b style="color:green;">abril </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_04}}" required>                                            
                                            @break                                            
                                        @case('5')
                                            <label >Avance del mes de <b style="color:green;">mayo </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_05}}" required>                                            
                                            @break   
                                        @case('6')
                                            <label >Avance del mes de <b style="color:green;">junio </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_06}}" required>                                            
                                            @break 
                                        @case('7')
                                            <label >Avance del mes de <b style="color:green;">julio </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_07}}" required>                                            
                                            @break
                                        @case('8')
                                            <label >Avance del mes de <b style="color:green;">agosto </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_08}}" required>                                            
                                            @break
                                        @case('9')
                                            <label >Avance del mes de <b style="color:green;">septiembre </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_09}}" required>                                            
                                            @break
                                        @case('10')
                                            <label >Avance del mes de <b style="color:green;">octubre </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_10}}" required>                                            
                                            @break                                            
                                        @case('11')
                                            <label >Avance del mes de <b style="color:green;">noviembre</b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_11}}" required>                                            
                                            @break   
                                        @case('12')
                                            <label >Avance del mes de <b style="color:green;">diciembre </b></label>
                                            <input type="number" min="0" max="999999999999" class="form-control" name="avance" id="avance" placeholder="Avance " value="{{$regprogdanual->mesc_12}}" required>                                            
                                            @break                                             
                                        @default
                            ...
                            <div class="row">                                
                                <div class="col-xs-12 form-group">
                                     <label >Justificación (4,000 caracteres)</label> 
                                        @switch($mes)
                                        @case('1')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_01}}</textarea>
                                            @break
                                        @case('2')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_02}}</textarea>
                                            @break
                                        @case('3')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_03}}</textarea>
                                            @break
                                        @case('4')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_04}}</textarea>
                                            @break                                            
                                        @case('5')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_05}}</textarea>
                                            @break   
                                        @case('6')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_06}}</textarea>
                                            @break 
                                        @case('7')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_07}}</textarea>
                                            @break
                                        @case('8')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_08}}</textarea>
                                            @break
                                        @case('9')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_09}}</textarea>
                                            @break
                                        @case('10')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_10}}</textarea>
                                            @break                                            
                                        @case('11') 
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_11}}</textarea>
                                            @break   
                                        @case('12')
                                            <textarea class="form-control" name="obs" id="obs" rows="3" cols="120" placeholder="Justificación (4,000 caracteres)" required>{{$regprogdanual->obs_12}}</textarea>
                                            @break                                             
                                        @default
                                            <label >sin justificar</label>
                                        @endswitch   
                                </div>                                
                            </div>
