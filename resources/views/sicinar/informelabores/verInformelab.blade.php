                            ...
                            <table id="tabla1" class="table table-hover table-striped">
                                <thead style="color: brown;" class="justify">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align:center; vertical-align: middle;font-size:11px;">Anual        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->totp_01,0)}}</td>
                                    ...
                                    <tr>
                                        <td style="color:#1a1c50;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:#1a1c50;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:#1a1c50;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:#1a1c50;text-align:left; vertical-align: middle;font-size:10px;">Avances</td>
                                        <td style="color:#1a1c50;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->totc_01,0)}}</td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 1) )}}" class="btn badge-warning" title="Editar avance de enero"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_01,0)}}</p></a>                                              
                                        </td>
                                        <td style="text-align:center;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 2) )}}" class="btn badge-warning" title="Editar avance de febrero"><i class="fa fa-edit"></i>
                                            <p style="font-size:10px;text-align:center;">{{number_format($dpa->mesc_02,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 3) )}}" class="btn badge-warning" title="Editar avance de marzo"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_03,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 4) )}}" class="btn badge-warning" title="Editar avance de abril"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_04,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 5) )}}" class="btn badge-warning" title="Editar avance de mayo"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_05,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 6) )}}" class="btn badge-warning" title="Editar avance de junio"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_06,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 7) )}}" class="btn badge-warning" title="Editar avance de julio"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_07,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 8) )}}" class="btn badge-warning" title="Editar avance de agosto"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_08,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida, 9) )}}" class="btn badge-warning" title="Editar avance de septiembre"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_09,0)}}</p></a> 
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida,10) )}}" class="btn badge-warning" title="Editar avance de octubre"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_10,0)}}</p></a>
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida,11) )}}" class="btn badge-warning" title="Editar avance de noviembre"><i class="fa fa-edit"></i>                                        
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_11,0)}}</p></a>
                                        </td>
                                        <td style="color:#1a1c50;text-align:center;vertical-align: middle;font-size:10px;">
                                            <a href="{{route('editarInformelab',array($dpa->folio,$dpa->partida,12) )}}" class="btn badge-warning" title="Editar avance de diciembre"><i class="fa fa-edit"></i>
                                            <p style="text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->mesc_12,0)}}</p></a>
                                        </td>
                                    </tr>           
                                    <tr>
                                        ...
                                        <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;">%</td>
                                        <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:purple;text-align:center;vertical-align: middle;font-size:10px;">{{number_format($dpa->tot_p01,2)}}</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;"></td>
                                        <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;">Semáforos</td>
                                        <td style="color:purple;text-align:left; vertical-align: middle;font-size:10px;"></td>   
                                        <td style="text-align:center;">  
                                        @switch($dpa->semafa_01)
                                        @case('1')
                                            <img src="{{ asset('images/semaforo_rojo.jpg') }}"    width="15px" height="15px" style="text-align:right;"/> 
                                            @break
                                        @case('2')
                                            <img src="{{ asset('images/semaforo_naranja.jpg') }}" width="15px" height="15px" style="text-align:right;"/> 
                                            @break
                                        @case('3')
                                            <img src="{{ asset('images/semaforo_amarillo.jpg')}}" width="15px" height="15px" style="text-align:right;"/> 
                                            @break
                                        @case('4')
                                            <img src="{{ asset('images/semaforo_verde.jpg') }}"   width="15px" height="15px" style="text-align:right;"/> 
                                            @break                                            
                                        @case('5')
                                            <img src="{{ asset('images/semaforo_morado.jpg') }}"  width="15px" height="15px" style="text-align:right;"/> 
                                            @break                                                                          
				                        @case('0')  
				                            @break
				                        @default
