                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    ...
                                    <input type="text" class="form-control" name="responsable" id="responsable" placeholder="Responsable" value="{{trim($regprogeanual->responsable)}}"  required>
                                </div>  
                                <div class="col-xs-4 form-group">
                                    <label >Cargo </label>
                                    <input type="text" class="form-control" name="resp_cargo" id="resp_cargo" placeholder="Cargo del responsable"value="{{trim($regprogeanual->resp_cargo)}}" required>
                                </div>                                  
                            </div>
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    <label >Elaboró </label>
                                    <input type="text" class="form-control" name="elaboro" id="elaboro" placeholder="Elaboró" value="{{trim($regprogeanual->elaboro)}}" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Cargo </label>
                                    <input type="text" class="form-control" name="elab_cargo" id="elab_cargo" placeholder="Cargo del que alaboró" value="{{trim($regprogeanual->elab_cargo)}}" required>
                                </div>                                  
                            </div>           
                            <div class="row">                     
                                <div class="col-xs-4 form-group">
                                    <label >Autorizó </label>
                                    <input type="text" class="form-control" name="autorizo" id="autorizo" placeholder="Autorizó" value="{{trim($regprogeanual->autorizo)}}" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Cargo </label>
                                    <input type="text" class="form-control" name="auto_cargo" id="auto_cargo" placeholder="Cargo del que autorizó" value="{{trim($regprogeanual->auto_cargo)}}" required>
                                </div>         
                            </div>
