                        ...
                        <div class="page-header" style="text-align:right;">
                            ...
                            {{ Form::open(['route' => 'buscarpa', 'method' => 'GET', 'class' => 'form-inline pull-right']) }}
                                <div class="form-group">
                                    {{ Form::text('namepr', null, ['class' => 'form-control', 'placeholder' => 'Programa']) }}
                                </div>                                             
                                <div class="form-group">
                                    {{ Form::text('namepy', null, ['class' => 'form-control', 'placeholder' => 'Proyecto']) }}
                                </div>   
                                                                  
                                <div class="form-group">
                                    {{ Form::text('namedep', null, ['class' => 'form-control', 'placeholder' => 'U. responsable']) }}
                                </div>                                    
