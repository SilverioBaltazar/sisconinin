                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-4 form-group">
                                    <label >Cargo </label>
                                    <input type="text" class="form-control" name="resp_cargo" id="resp_cargo" placeholder="Cargo del responsable" required>
                                </div>                                  
                            </div>
                            <div class="row">
                                <div class="col-xs-4 form-group">
                                    <label >Elaboró </label>
                                    <input type="text" class="form-control" name="elaboro" id="elaboro" placeholder="Elaboró" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Cargo </label>
                                    <input type="text" class="form-control" name="elab_cargo" id="elab_cargo" placeholder="Cargo del que alaboró" required>
                                </div>                                  
                            </div>           
                            <div class="row">                     
                                <div class="col-xs-4 form-group">
                                    <label >Autorizó </label>
                                    <input type="text" class="form-control" name="autorizo" id="autorizo" placeholder="Autorizó" required>
                                </div>
                                <div class="col-xs-4 form-group">
                                    <label >Cargo </label>
                                    <input type="text" class="form-control" name="auto_cargo" id="auto_cargo" placeholder="Cargo del que autorizó" required>
                                </div>                                  
                            </div>
