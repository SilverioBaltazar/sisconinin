...
class ExcelExportMensualcon_v2 implements FromCollection, /*FromQuery,*/ WithHeadings
{
    ...
    public function __construct($periodo_id, $mes_id, $depen_id, $taccion_id, $data, $i)
    {
