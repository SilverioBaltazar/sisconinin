...
class ExcelExportMensualbddet implements FromCollection, /*FromQuery,*/ WithHeadings
{
        ...
        switch($mes_id){ 
            case '1':
		        return ['PERIODO_ID','UNID_ADMON_ID','UNID_ADMON','EPPROY_ID','EP_PROYECTO',
		                'FOLIO','CLAVE','NP','NO_IGOB','ACCION_META','UNIDAD_MEDIDA',
            ...
            case '1':
                if($depen_id == '0' && $taccion_id == '0' ){                                 
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S01')
                               ...
                               ->select(
                                        ...
                                        'SIEVAD_DPA.ACUMC_01',
                                        'SIEVAD_DPA.ACUM_P01',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S01', 
                        ...
                        if($depen_id <> '0' && $taccion_id == '0' ){   
                            ...
                            if($depen_id <> '0' && $taccion_id <> '0' ){   
			                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
				                           ...
				                           ->orderBy(  'SIEVAD_DPA.DEPEN_ID2' ,'ASC')
				                           ->orderBy(  'SIEVAD_DPA.FOLIO'     ,'ASC')
				                           ->orderBy(  'SIEVAD_DPA.PARTIDA'   ,'ASC')     			                           ->Where(    'SIEVAD_DPA.PERIODO_ID','=',$periodo_id)
				                           ->get();            
                            }    // END IF
                        }    //END IF
                    }    //END IF
            ...
            case '2':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S02')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_02',
                                        'SIEVAD_DPA.ACUM_P02',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S02', 
            ...
            case '3':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S03')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_03',
                                        'SIEVAD_DPA.ACUM_P03',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S03', 
            ...
            case '4':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S04')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_04',
                                        'SIEVAD_DPA.ACUM_P04',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S04', 
            ...
            case '5':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S05')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_05',
                                        'SIEVAD_DPA.ACUM_P05',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S05', 
            ...
            case '6':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S06')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_06',
                                        'SIEVAD_DPA.ACUM_P06',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S06', 
            ...
            case '7':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S07')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_07',
                                        'SIEVAD_DPA.ACUM_P07',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S07', 
            ...
            case '8':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S08')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_08',
                                        'SIEVAD_DPA.ACUM_P08',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S08', 
            ...
            case '9':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S09')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_09',
                                        'SIEVAD_DPA.ACUM_P09',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S09', 
            ...
            case '10':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S10')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_10',
                                        'SIEVAD_DPA.ACUM_P10',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S10', 
            ...
            case '11':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S11')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_11',
                                        'SIEVAD_DPA.ACUM_P11',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S11', 
                        ...
                        if($depen_id <> '0' && $taccion_id == '0' ){   
		                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
			                               ...
			                               ->select(
			                                        ...
			                                        'SIEVAD_DPA.MESC_04',
			                                        'SIEVAD_DPA.MES_P04',
			                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS MES_S04',
            ...
            case '12':
                if($depen_id == '0' && $taccion_id == '0' ){              
                    return regProgdAnualModel::join('SIEVAD_CAT_UMEDIDA','SIEVAD_CAT_UMEDIDA.UMED_ID','='
                                 ...
                                 ->join('SIEVAD_CAT_COLORES_ACUM','SIEVAD_CAT_COLORES_ACUM.COLOR_ID','=','SIEVAD_DPA.ACUM_S12')
                                 ->join('SIEVAD_EPA'             ,'SIEVAD_EPA.FOLIO'                ,'=','SIEVAD_DPA.FOLIO')
                               ->select(
                                        'SIEVAD_DPA.PERIODO_ID',
                                        'SIEVAD_DPA.DEPEN_ID2',
                                        ...
                                        'SIEVAD_DPA.ACUMC_12',
                                        'SIEVAD_DPA.ACUM_P12',
                                        'SIEVAD_CAT_COLORES_ACUM.COLOR_COLOR AS ACUM_S12', 
