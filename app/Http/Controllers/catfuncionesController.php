...
class catfuncionesController extends Controller
{
    ...
    public function actionVerFuncion(){
        ...
        $regfuncion = regFuncionModel::join('SIEVAD_CAT_PROCESOS','SIEVAD_CAT_PROCESOS.PROCESO_ID','=','SIEVAD_CAT_FUNCIONES.PROCESO_ID')
                                   ->select('SIEVAD_CAT_FUNCIONES.PROCESO_ID','SIEVAD_CAT_PROCESOS.PROCESO_DESC','SIEVAD_CAT_FUNCIONES.FUNCION_ID','SIEVAD_CAT_FUNCIONES.FUNCION_DESC','SIEVAD_CAT_FUNCIONES.FUNCION_STATUS','SIEVAD_CAT_FUNCIONES.FUNCION_FECREG')
                                   ->orderBy('SIEVAD_CAT_FUNCIONES.PROCESO_ID','ASC')
                                   ->orderBy('SIEVAD_CAT_FUNCIONES.FUNCION_ID','ASC')
                                   ->paginate(30);
