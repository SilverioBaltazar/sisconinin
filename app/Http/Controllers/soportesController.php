...
use App\Http\Requests\soportedetRequest;
...
class soportesController extends Controller
{
    ...
    public function actionBuscarSoporte(Request $request)
    {
        ...
        return view('sicinar.informelabores.verSoportes',compact('nombre','usuario','regdepen','reganios','regperiodos','regmeses','regdias','regprogeanual','totactivs','regepprog','regepproy'));
    }
    ...
    public function actionVerSoportesdet($id){
        ...
        $regprogdanual= regProgdAnualModel::select('FOLIO','PARTIDA','PERIODO_ID','CIPREP_ID','LGOB_COD',
                        ...
                        'LINK_07','LINK_08','LINK_09','LINK_10','LINK_11','LINK_12',
                        'OBS_01','OBS_02',
                        'STATUS_1','STATUS_2','FECREG','FECREG2','IP','LOGIN','FECHA_M','FECHA_M2','IP_M','LOGIN_M')        
                        ->where(  'FOLIO'  ,$id)            
                        ->orderBy('FOLIO'  ,'asc')
        ...
        return view('sicinar.informelabores.verSoportesdet',compact('nombre','usuario','regdepen','regumedida','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regepprog','regepproy'));
    }
    ...
    public function actionEditarSoportedet($id, $id2, $id3){
        $nombre       = session()->get('userlog');
        $pass         = session()->get('passlog');
        if($nombre == NULL AND $pass == NULL){
            return view('sicinar.login.expirada');
        ...
        $mes = $id3;
        return view('sicinar.informelabores.editarSoportedet',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog','mes'));
    }


    public function actionActualizarSoportedet(soportedetRequest $request, $id, $id2, $id3){
        $nombre        = session()->get('userlog');
        $pass          = session()->get('passlog');
        if($nombre == NULL AND $pass == NULL){
            return view('sicinar.login.expirada');
        ...
        if($regprogdanual->count() <= 0)
            ...
            case 1:    //Mes diciembre            
                if($request->hasFile('soporte')){
                    $name = $request->periodo_id.'_'.$id.'_'.$id2.'_'.$request->file('soporte')->getClientOriginalName(); 
                    $request->file('soporte')->move(public_path().'/storage/', $name);

                    $regprogdanual = regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                                     ->update([                
                                               'SOPORTE_01' => $name,
                                               'LINK_01'    => $request->link,
            ...
            case 12:    //Mes diciembre            
                ...
                if($regbitacora->count() <= 0){              // Alta
                    ...
                    $nuevoregBitacora->save();
                    if($nuevoregBitacora->save() == true)
                        toastr()->success('Trx de Archivo digital registrado en Bitacora.','¡Ok!',['positionClass' => 'toast-bottom-right']);
                    else
                        toastr()->error('Error en Trx de Archivo digital. Por favor volver a interlo.','Ups!',['positionClass' => 'toast-bottom-right']);
                }else{                   
                    //*********** Obtine el no. de veces *****************************
                    $xno_veces = regBitacoraModel::where(['PERIODO_ID' => $xperiodo_id,'MES_ID'    => $xmes_id,
                                                          'PROCESO_ID' => $xproceso_id,'FUNCION_ID'=> $xfuncion_id, 
                    ...
                    toastr()->success('Trx de Archivo digital actualizado en Bitacora.','¡Ok!',['positionClass' => 'toast-bottom-right']);
                }   /************ Bitacora termina *************************************/       
            //}       /************ Valida si viene vacio el arc. digital ****************/                              
        }           /************ Actualizar *******************************************/
    ...
    public function actionEditarSoportedet1($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet1',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet2($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet2',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet3($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet3',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet4($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet4',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet5($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet5',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet6($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet6',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet7($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet7',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
   ...
   public function actionEditarSoportedet8($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet8',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
    ...
    public function actionEditarSoportedet9($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet9',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
    ...
    public function actionEditarSoportedet10($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet10',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
    ...
    public function actionEditarSoportedet11($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet11',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
    ...
    public function actionEditarSoportedet12($id,$id2){
        ...
        return view('sicinar.informelabores.editarSoportedet12',compact('nombre','usuario','regdepen','regtipometa','regperiodos','regmeses','regdias','regprogeanual','regprogdanual','regumedida','regepproy','regepprog'));
    }
    ...
    public function actionBorrarSoportedet($id,$id2, $id3){
        //dd($request->all());
        $nombre       = session()->get('userlog');
        $pass         = session()->get('passlog');
        if($nombre == NULL AND $pass == NULL){
        ...
        if($regprogdanual->count() <= 0)
            ...
            case 1:    //mes enero
                ...
                toastr()->success('Soporte actualizado.','¡Ok!',['positionClass' => 'toast-bottom-right']);
                break;
            case 2:    //Mes febrero
                $regprogdanual= regProgdAnualModel::where(['FOLIO' => $id, 'PARTIDA' => $id2])        
                            ->update([                
            ...
            if($regbitacora->count() <= 0){              // Alta
                ...
                $nuevoregBitacora->save();
                if($nuevoregBitacora->save() == true)
                    toastr()->success('Trx de borrar archivo de soporte registrada en Bitacora.','¡Ok!',['positionClass' => 'toast-bottom-right']);
                else
                    toastr()->error('Error Trx de borrar archivo de soporte. Por favor volver a interlo.','Ups!',['positionClass' => 'toast-bottom-right']);
            }else{                   
                //*********** Obtine el no. de veces *****************************
                $xno_veces = regBitacoraModel::where(['PERIODO_ID' => $xperiodo_id,'MES_ID' => $xmes_id,'PROCESO_ID' => $xproceso_id, 
                                                      'FUNCION_ID' => $xfuncion_id,'TRX_ID' => $xtrx_id,'FOLIO'      => $id])
                ...
                toastr()->success('Trx de borrar archivo de soporte actualizada en Bitacora.','¡Ok!',['positionClass' => 'toast-bottom-right']);
            }   /************ Bitacora termina *************************************/                 
        }       /************* Termina de eliminar *********************************/
        return redirect()->route('versoportesdet',$id);
    }    
