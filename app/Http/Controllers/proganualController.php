...
class proganualController extends Controller
{
    ...
    public function actionBuscarPA(Request $request)
    {
        ...
        if(session()->get('rango') !== '0'){    
            ...
            $regprogeanual= regProgeAnualModel::join('SIEVAD_CAT_DEPENDENCIAS','SIEVAD_CAT_DEPENDENCIAS.DEPEN_ID','=',
                            ...
                            ->select( 'SIEVAD_CAT_DEPENDENCIAS.DEPEN_DESC',
                                      'SIEVAD_EPA.*')
            ...
            $regprogeanual= regProgeAnualModel::join('SIEVAD_CAT_DEPENDENCIAS','SIEVAD_CAT_DEPENDENCIAS.DEPEN_ID','=',
                            ...
                            ->namepr($namepr)  //Metodos personalizados                                  
                            ->namepy($namepy)    //Metodos personalizados
                            ->namepy($namedep)   //Metodos personalizados
                            ->paginate(50);   
        }                                                                          
    ...
    public function actionNuevoPA(){
        ...
        $regprogeanual= regProgeAnualModel::select('FOLIO','PERIODO_ID','DEPEN_ID1','DEPEN_ID2','DEPEN_ID3',
                        ...
                        'OBS_1','OBS_2','STATUS_1','STATUS_2','FECREG','FECREG2','IP','LOGIN')
    ...
    public function actionAltaNuevoPA(Request $request){
        ...
        ////else{  
            ...
            $nuevoprogtrab->RESP_CARGO    = substr(trim(strtoupper($request->resp_cargo)) ,0, 149);
            $nuevoprogtrab->ELAB_CARGO    = substr(trim(strtoupper($request->elab_cargo)) ,0, 149);
            $nuevoprogtrab->AUTO_CARGO    = substr(trim(strtoupper($request->auto_cargo)) ,0, 149);
    ...
    public function actionActualizarPA(progeanualRequest $request, $id){
        ...
        if($regprogeanual->count() <= 0)
            ...
            $regprogeanual = regProgeAnualModel::where('FOLIO',$id)        
                ...
                'RESP_CARGO'    => substr(trim(strtoupper($request->resp_cargo)) ,0, 149),
                'ELAB_CARGO'    => substr(trim(strtoupper($request->elab_cargo)) ,0, 149),
                'AUTO_CARGO'    => substr(trim(strtoupper($request->auto_cargo)) ,0, 149),                  
    ...
    public function actionAltaNuevodPA(Request $request){
        ...
        //else{  
            ...
            //*************** Calcular acumulados mensuales programados ***************//
            $acump_01 = (float)$mesp_01;
            $acump_02 = (float)$mesp_01+(float)$mesp_02;
            $acump_03 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03;
            $acump_04 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04;
            $acump_05 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05;
            $acump_06 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06;
            $acump_07 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06+(float)$mesp_07;
            $acump_08 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06+(float)$mesp_07+(float)$mesp_08;
            $acump_09 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06+(float)$mesp_07+(float)$mesp_08+(float)$mesp_09;
            $acump_10 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06+(float)$mesp_07+(float)$mesp_08+(float)$mesp_09+(float)$mesp_10;
            $acump_11 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06+(float)$mesp_07+(float)$mesp_08+(float)$mesp_09+(float)$mesp_10+(float)$mesp_11;
            $acump_12 = (float)$mesp_01+(float)$mesp_02+(float)$mesp_03+(float)$mesp_04+(float)$mesp_05+(float)$mesp_06+(float)$mesp_07+(float)$mesp_08+(float)$mesp_09+(float)$mesp_10+(float)$mesp_11+(float)$mesp_12;
            ...
            $nuevoprogdtrab->ACUMP_01       = $acump_01;
            $nuevoprogdtrab->ACUMP_02       = $acump_02;
            $nuevoprogdtrab->ACUMP_03       = $acump_03;
            $nuevoprogdtrab->ACUMP_04       = $acump_04;
            $nuevoprogdtrab->ACUMP_05       = $acump_05;
            $nuevoprogdtrab->ACUMP_06       = $acump_06;
            $nuevoprogdtrab->ACUMP_07       = $acump_07;
            $nuevoprogdtrab->ACUMP_08       = $acump_08;
            $nuevoprogdtrab->ACUMP_09       = $acump_09;
            $nuevoprogdtrab->ACUMP_10       = $acump_10;
            $nuevoprogdtrab->ACUMP_11       = $acump_11;
            $nuevoprogdtrab->ACUMP_12       = $acump_12;
